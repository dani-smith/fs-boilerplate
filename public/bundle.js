...
exports.fetchColours = fetchColours;
...
function fetchColours() {
    return function (dispatch) {
        _superagent2.default.get('/api/v1/colours').then(function (res) {
            return res.body;
...
var App = function (_React$Component) {
    ...
    _createClass(App, [{
        ...
        value: function componentDidMount() {
            this.props.dispatch((0, _actions.fetchColours)());
        }
    }, {
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'ul',
                    null,
                    this.props.colours.length > 0 && this.props.colours.map(function (colour) {
                        return _react2.default.createElement(
                            'li',
                            { key: colour.id },
                            colour.colour
...
var _colours = __webpack_require__(/*! ./colours */ "./client/reducers/colours.js");
